...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(
		...
		return args -> {
			...
			Client cliente1 = clientRepository.save(new Client("Melba", "Morel", "melba@mindhub.com", passwordEncoder.encode("M0__3L")));
			...
			Card card3 = cardRepository.save(new Card("Rodrigo Ribeiro", CardType.CREDIT, CardColor.SILVER, "8909-2893-5764-8765", 320, fechaHoy,fechaVencimiento));
